        ...
        <div class="mobile-nav" id="mobile-nav">
            ...
            <ul class="mobile-nav-links active">
                ...
                <li class="<?php echo $currentClass == 'news' ? 'active' : '' ?>">
                    <a href="<?php echo 'http://blog.fightcompanions.com'; ?>">MMA News</a>
                </li>
        ...
        <div class="nav">
            <ul class="nav-links">
                ...
                <li class="<?php echo $currentClass == 'news' ? 'active' : '' ?> header-parent level0">
                    <a href="<?php echo 'http://blog.fightcompanions.com'; ?>"><span class="span-level0">MMA News</span></a>
                </li>
                <li>
